    ...
    <div className='max-w-[1344px] mx-auto flex-col flex items-center my-20'>
      ...
      <div className='pt-1 bg-nlw-gradient self-stretch rounded-lg overflow-hidden mt-8'>
        <div className='bg-[#2A2634] px-8 py-6 flex justify-between items-center'>
          <div>
            <strong className='text-2xl text-white font-black block'>Didn't find your duo yet?</strong>
            <span className='text-zinc-400 block'>Post an annouce to find new players!</span>
          </div>
